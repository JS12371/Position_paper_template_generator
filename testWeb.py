...
if uploaded_file and st.session_state.df is None:
    ...
    available_columns = pd.read_excel(uploaded_file, sheet_name=sheet_names[0], engine='openpyxl', nrows=0).columns.tolist()
    ...
    st.session_state.df = pd.read_excel(uploaded_file, sheet_name=sheet_names[0], usecols=columns_to_load, engine='openpyxl')
