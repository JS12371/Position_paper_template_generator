...
def mac_num_to_name(mac_num): 
    mac_dict = {
        '05': 'WPS Government Health Administrators (J-5)',
        '06': 'National Government Services (J-6)',
        '08': 'WPS Government Health Administrators (J-8)',
        '15': 'CGS Administrators (J-15)',
        '01': 'Noridian Healthcare Solutions c/o Cahaba Safeguard Administrators (J-E)',
        '02': 'Noridian Healthcare Solutions (J-F)',
        '03': 'Noridian Healthcare Solutions (J-F)',
        '04': 'Novitas Solutions, Inc. (J-H)',
        '07': 'Novitas Solutions, Inc. (J-H)',
        '10': 'Palmetto GBA (J-I)',
        '13': 'National Government Services, Inc. (J-K)',
        '12': 'Novitas Solutions, Inc. (J-L)',
        '11': 'Palmetto GBA c/o National Government Services, Inc. (J-M)',
        '09': 'First Coast Service Options, Inc. (J-N)'
    }
    return mac_dict.get(mac_num[:2], 'MAC not found')
...
def find_case_data(df, case_number): 
    ...
    case_data = case_data.applymap(string_processing) 
    return case_data 
...
# Function to read the Excel file in chunks
...
if uploaded_file and st.session_state.df is None:
    st.session_state.df = load_excel_chunks(uploaded_file)
