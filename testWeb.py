...
def load_excel(file):
    # Specify the columns that are necessary for your program
    cols_to_load = [
        'Case Num', 'Case Name', 'Issue', 'Provider ID', 'Provider Name', 
        'MAC', 'Determination Event Date', 'Appeal Date', 'Audit Adj No.', 
        'Transferred to Case #', 'Issue Typ', 'Group FYE', 'FYE'
    ]
    return pd.read_excel(file, usecols=cols_to_load, engine='openpyxl')
